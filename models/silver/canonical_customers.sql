select
    ...
    cct.customer_lifetime_order_count,
    cct.customer_lifetime_total_value_sum,
    cct.customer_lifetime_total_value_avg,
    ...
    sc.created_at_timestamp as shopify_customer_created_at,
    sc.updated_at as shopify_customer_updated_at,
